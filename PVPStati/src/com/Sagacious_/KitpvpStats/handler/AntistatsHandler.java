...
public class AntistatsHandler implements Listener{
	...
	public AntistatsHandler() {
		...
		old=Double.valueOf(Bukkit.getServer().getClass().getPackage().getName().split("_")[1])<14;
	...
	public void onDeath(PlayerDeathEvent e) {
		...
		if(old?Core.getInstance().wh.countstats1_8(e.getEntity()):Core.getInstance().wh.countstats1_14(e.getEntity())) {
		if(max_kills>0) {
